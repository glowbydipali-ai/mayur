...
const SERVICES = [
  ...
  },
  {
    ...
    desc: 'Gala, prom, anniversaries, graduations — look unforgettable for every milestone that matters.',
    price: 'From ₹1800',
  ...
  },
  {
    ...
    desc: 'Coordinated, cohesive looks for the full bridal party or group event. On-location service available.',
    price: 'From ₹1500/person',
    duration: 'Varies',
    featured: false,
  },
  {
